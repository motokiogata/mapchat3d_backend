...
def handle_send_message(event):
    try:
        ...
        # Create prompt
        prompt = (
            "Your name is Mariko and You are a working for Tokio Marine Nichido , the insurance company as an helpful operator of claim reception about traffic accidents. "
            "Ask for time, location, vehicles, damages, injuries, and insurance info.\n\n"
            f"Human: {user_msg}\n\nAssistant:"
        )
